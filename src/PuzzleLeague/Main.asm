// GameCube "Puzzle League" Japanese To English Translation

endian msb // GameCube PPC requires Big-Endian Encoding (Most Significant Bit)
output "/fs/panepon-eng.rel", create
origin $000000; insert "/fs/panepon.rel" // Include Japanese ycookie.rel
